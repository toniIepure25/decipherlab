...
DATASET_CONFIGS = [
    ("omniglot_sequence_markov", Path("configs/experiments/sequence_omniglot_markov.yaml")),
    ("sklearn_digits_sequence_markov", Path("configs/experiments/sequence_sklearn_digits_markov.yaml")),
    ("kuzushiji49_sequence_markov", Path("configs/experiments/sequence_kuzushiji_markov_cross_dataset.yaml")),
]
...
def main() -> None:
    ...
    outputs = build_sequence_cross_dataset_outputs(dataset_runs, output_root="outputs")
