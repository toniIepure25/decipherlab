...
- Supporting figure/table: `Figure 1`, `Table 1`
- Repo artifacts: `outputs/real_grouped_replication_summary.csv`, `outputs/propagation_regime_summary.csv`, `outputs/real_vs_synthetic_bridge_summary.csv`

## Major Supporting Claims

- Claim: Grouped top-k rescue replicates across Historical Newspapers and ScaDS.AI.
- Manuscript location: `sections/05_results.tex`
- Supporting figure/table: `Figure 1`, `Table A1`
- Repo artifacts: `outputs/real_grouped_replication_summary.csv`, `outputs/statistical_robustness_summary.csv`

- Claim: The redesigned real downstream task removes the strongest prior coverage objection.
...
- Claim: Historical Newspapers is trustworthy enough for a bounded real grouped-recognition claim after trust hardening.
